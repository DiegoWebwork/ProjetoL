...
function HomeScreen(props) {
  ...
  async function getData() {
    ...
    console.log(token);
    axios
      .post('http://10.0.0.5:3000/userdata', {token: token})
      .then(res => {
  ...
  const handleBackPress = () => {
    Alert.alert('Exit App', 'Tem certeza que deseja sair?', [
      {
        text: 'Cancel',
        onPress: () => null,
        style: 'cancel',
    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      <View>
        ...
        <View style={{marginTop: -50}}>
          <Text style={styles.nameText}>{userData?.name || 'usuario nao encontrado'}</Text>
        </View>
            ...
            <View style={styles.infoCont}>
              ...
              <View style={styles.infoText}>
                ...
                <Text style={styles.infoLarge_Text} numberOfLines={1}>
                  {userData?.email || 'usuario nao encontrado'}
                </Text>
              </View>
            </View>
          </View>
